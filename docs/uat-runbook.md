...
| Tools-inventory card count | dashboard card may list 5 legacy entries; Pi registers 8 voice tools | treat the dashboard as stale presentation, verify Pi inventory separately |
